...
/**
 * Controller class to handle a collection of advanced validation patterns
 *
 * @author Robin
 * @author Arvid
 */
@ViewScoped
@Named
public class ValidationPatternsAdvancedController extends OverviewController<ValidationPattern> {
    ...
    @Override
    public void refresh() {
        List<ValidationPattern> validationPatterns = validationPatternService.getByAdvanced(true);
    ...
    /**
     * Validationpatterns have no id, name is the id.
     * @param id the id
     * @return nothing
     */
    @Override
