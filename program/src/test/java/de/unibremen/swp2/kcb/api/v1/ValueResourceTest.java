...
/**
 * Class ValueResourceTest
 *
 * @author Marius
 */
public class ValueResourceTest {
    ...
    public void testCreateNormal() throws CreationException {
        when(service.create(any())).thenReturn(mockedValue);
        when(jsonUtil.marshal(any())).thenReturn("");
        resource.create(mockedValue);
        verify(service, times(1)).create(mockedValue);
    }
    ...
    public void testUpdateNormal() throws UpdateException, InvalidIdException {
        when(service.update(mockedValue)).thenReturn(mockedValue);
        when(service.getById(any())).thenReturn(mockedValue);
        when(jsonUtil.marshal(any())).thenReturn("");
        resource.update(mockedValue);
        verify(service, times(1)).update(mockedValue);
    }
    ...
    public void testUpdateFail() throws UpdateException, InvalidIdException {
        when(service.update(mockedValue)).thenThrow(UpdateException.class);
        when(service.getById(any())).thenReturn(mockedValue);
        when(jsonUtil.marshal(any())).thenReturn("");
        String response = resource.update(mockedValue);
        verify(service, times(1)).update(mockedValue);
    }
