...
/**
 * The type Assembly resource test.
 *
 * @author Marius
 */
public class AssemblyResourceTest {
     ...
     */
    @Mock
    private Assembly mockedAssembly;
    ...
    public void testCreateNormal() throws CreationException {
        when(service.create(any())).thenReturn(mockedAssembly);
        when(jsonUtil.marshal(any())).thenReturn("");
        resource.create(mockedAssembly);
        verify(service, times(1)).create(mockedAssembly);
    }
    ...
    public void testUpdateNormal() throws UpdateException, InvalidIdException {
        when(service.update(mockedAssembly)).thenReturn(mockedAssembly);
        when(service.getById(any())).thenReturn(mockedAssembly);
        when(jsonUtil.marshal(any())).thenReturn("");
        resource.update(mockedAssembly);
        verify(service, times(1)).update(mockedAssembly);
    }
    ...
    public void testUpdateFail() throws UpdateException, InvalidIdException {
        when(service.update(mockedAssembly)).thenThrow(UpdateException.class);
        when(service.getById(any())).thenReturn(mockedAssembly);
        when(jsonUtil.marshal(any())).thenReturn("");
        String response = resource.update(mockedAssembly);
        verify(service, times(1)).update(mockedAssembly);
    }
